        ...
        <div>
            ...
            <div id="salesList" class="hidden">
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    <?php $__currentLoopData = auth()->user()->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-white rounded-lg overflow-hidden">
                            <a href="<?php echo e(route('item.show', $item->id)); ?>" class="block">
                                ...
                                <div class="p-4">
                                    <h4 class="text-base text-gray-900"><?php echo e($item->name); ?></h4>
                                </div>
                            </a>
                        </div>
            ...
            <div id="purchasesList" class="hidden">
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    <?php $__currentLoopData = auth()->user()->purchases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-white rounded-lg overflow-hidden">
                            <a href="<?php echo e(route('item.show', $purchase->item->id)); ?>" class="block">
                                <div class="aspect-w-1 aspect-h-1">
                                ...
                                <div class="p-4">
                                    <h4 class="text-base text-gray-900"><?php echo e($purchase->item->name); ?></h4>
                                </div>
                            </a>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
