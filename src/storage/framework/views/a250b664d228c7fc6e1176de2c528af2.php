...
<nav role="navigation" aria-label="Pagination Navigation" class="flex justify-center">
    <ul class="inline-flex space-x-1">
        ...
        <?php if($paginator->onFirstPage()): ?>
        <li class="px-3 py-2 text-gray-400 border rounded">
            <span aria-hidden="true">&lsaquo;</span>
        </li>
        <?php else: ?>
        <li class="px-3 py-2 text-gray-400 border rounded hover:bg-gray-200">
            <a href="<?php echo e($paginator->previousPageUrl()); ?>" rel="prev" aria-label="<?php echo app('translator')->get('pagination.previous'); ?>" class='text-gray-400'>&lsaquo;</a>
        </li>
        <?php endif; ?>
        ...
        <?php if(is_string($element)): ?>
        <li class="px-3 py-2 text-gray-400"><?php echo e($element); ?></li>
        <?php endif; ?>
        ...
        <?php $__currentLoopData = $element; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if($page == $paginator->currentPage()): ?>
        <li class="px-3 py-2 text-white bg-main-color border rounded">
            <span class="font-bold"><?php echo e($page); ?></span> 
        </li>
        <?php else: ?>
        <li class="px-3 py-2 border rounded hover:bg-gray-200">
            <a href="<?php echo e($url); ?>" class='text-gray-400'><?php echo e($page); ?></a>
        </li>
        <?php endif; ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endif; ?>
        ...
        <?php if($paginator->hasMorePages()): ?>
        <li class="px-3 py-2 text-gray-400 border rounded hover:bg-gray-200">
            <a href="<?php echo e($paginator->nextPageUrl()); ?>" rel="next" aria-label="<?php echo app('translator')->get('pagination.next'); ?>" class='text-gray-400'>&rsaquo;</a>
        </li>
        <?php else: ?>
        <li class="px-3 py-2 text-gray-400 border rounded">
...
<?php endif; ?><?php /**PATH /var/www/resources/views/vendor/pagination/tailwind.blade.php ENDPATH**/ ?>