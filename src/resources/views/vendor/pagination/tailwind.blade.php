...
<nav role="navigation" aria-label="Pagination Navigation" class="flex justify-center">
    <ul class="inline-flex space-x-1">
        ...
        <li class="px-3 py-2 text-gray-400 border rounded hover:bg-gray-200">
            <a href="{{ $paginator->previousPageUrl() }}" rel="prev" aria-label="@lang('pagination.previous')" class='text-gray-400'>&lsaquo;</a>
        </li>
        @endif
        ...
        <li class="px-3 py-2 text-white bg-main-color border rounded">
            <span class="font-bold">{{ $page }}</span> {{-- ページ番号を<span>で囲むことで明示的に表示 --}}
        </li>
        @else
        <li class="px-3 py-2 border rounded hover:bg-gray-200">
            <a href="{{ $url }}" class='text-gray-400'>{{ $page }}</a>
        </li>
        @endif
        @endforeach
        @endif
        ...
        @if ($paginator->hasMorePages())
        <li class="px-3 py-2 text-gray-400 border rounded hover:bg-gray-200">
            <a href="{{ $paginator->nextPageUrl() }}" rel="next" aria-label="@lang('pagination.next')" class='text-gray-400'>&rsaquo;</a>
        </li>
        @else
        <li class="px-3 py-2 text-gray-400 border rounded">
